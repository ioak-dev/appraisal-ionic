...
//  }
  ...
  function renderTokens() {
    if (sessionStorage.accessToken) {
      ...
      $('#displayName', window.parent.document).text(sessionStorage.userDisplayName);
      $('#domainType', window.parent.document).text(sessionStorage.userDomainType);
      $('#signinName', window.parent.document).text(sessionStorage.userSigninName);
...
//    setActiveNav('#home-nav');
    if (isAuthed) {
      $('#username').text(sessionStorage.userSigninName);
